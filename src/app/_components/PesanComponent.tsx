...
export default function PesanComponent() {
    return (
        <div className="my-20 mx-auto text-center">
            ...
            <a href="https://wa.me/6281385976170" target="_blank" rel="noopener noreferrer" title="WhatsApp">
                <div className="text-2xl mt-8 text-nowrap bg-dgreen border-dgreen border-[2px] rounded active:shadow-lg hover:bg-[#f5f5f5] hover:text-dgreen hover:border-[2px] hover:border-dgreen hover:cursor-pointer text-white transition-all lg:mt-12 py-2 w-36 mx-auto">
                    Pesan
                </div>
            </a>
