...
export default function Hero({ bgImage, link = "/menu" }: HeroProps) {
    return (
        <div className="hero lg:flex">
            <div style={{ backgroundImage: `url(${bgImage})` }} className="bg-cover bg-center lg:h-[720px] lg:w-8/12 h-[270px]">
            </div>
